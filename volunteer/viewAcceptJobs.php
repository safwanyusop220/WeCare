...
<div class="greenFormWrap">
            <h1 style="color:white;">VOLUNTEER - Accepted JOBS</h1>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane show active" id="scroll-vertical-preview alt-pagination-preview">
                                    <table id="scroll-vertical-datatable" class="table dt-responsive nowrap w-100">
                                        ...
                                        <?php
                                            //Query
                                            $sql = "SELECT * FROM request_supply WHERE acceptBy ='$sessionUserId'";
                                        ...
                                        <input type="hidden" value="<?=$id?>" name="id">
                                            ...
                                            <td style="text-align:center;">
                                                <a href="#" class="btn btn-success btn-sm"><i class="mdi mdi-calendar-multiple-check mdi-18px" style="color: white; icon-large"></i> Completed</a>
                                            </td>
                                        </tr>
                                        </tbody>
                                        <?php      
