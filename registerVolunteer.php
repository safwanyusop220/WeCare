...
<html>
    ...
    <body>
        ...
        <?php echo "<a style='color:#194E8C; border-radius: 45px; margin-left:66%; padding: 2% 5%; font-size: 1.5em;'  href='register.php' class='highlighted'>Patient Registration</a>"?>
        <div class="greenFormWrap">
            
            <form class ="loginForm" method="POST" action="sql/registerVolunteerSql.php">
